...
class Mesh2d(object):
    ...
    @staticmethod
    def from_polygon(poly, convex_relax_thresh):
        m = Mesh2d()
    ...
    @staticmethod
    def find_spikes(poly, threshold = 0.0):
        spikes = []
    ...
    @staticmethod
    def find_portals(poly, threshold = 0.0):
        ...
        for spike in spikes:
            ...
            right_dir, left_dir = Mesh2.get_sector(v0, v1, v2, threshold)
